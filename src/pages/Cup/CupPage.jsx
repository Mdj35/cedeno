...
export default function CupPage() {
    ...
    const handleAddToCart = () => {
        if (cup) { 
            ...
            adjustedCup.price = printOption === 'with' ? cup.price + 2 : cup.price;
    ...
    return (
        <div className={classes.container}>
            ...
            <div className={classes.price}>
                <Price price={printOption === 'with' ? cup.price + 2 : cup.price} /> {/* Display adjusted price */}
            </div>
            ...
            <div className={classes.printOptionContainer}>
                ...
                >
                    ...
                    />
                    With Print (+₱2.00) {/* Updated label to ₱5.00 */}
                </label>
            </div>
